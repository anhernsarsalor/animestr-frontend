...
export function filterNoReplies(event: NDKEvent | Event) {
...
export function filterOnlyDirectReplies(parent: NDKEvent | Event) {
  return function (event: NDKEvent | Event): boolean {
